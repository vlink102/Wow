...
import me.vlink102.render.RenderUtil;
                        ...
                        for (int x = minX; x <= maxX; x++) {
                            ...
                            if (b1 >= 0 && b1 <= 1 && b2 >= 0 && b2 <= 1 && b3 >= 0 && b3 <= 1) {
                                ...
                                if (zBuffer[zIndex] < depth) {
                                    img.setRGB(x, y, RenderUtil.getShade(t.color, angleCos).getRGB());
    ...
    public static List<Triangle> inflate(List<Triangle> tris) {
        ...
        for (Triangle t : result) {
            for (Vertex v : new Vertex[] { t.v1, t.v2, t.v3 }) {
                double l = Math.sqrt(v.x * v.x + v.y * v.y + v.z * v.z) / 173.205080757;
                v.x /= l;
                v.y /= l;
                v.z /= l;
            }
    ...
    public static void mains(String[] args) {
        ...
        JPanel renderPanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                RenderUtil.renderOld(RenderUtil.tetrahedron(), this, graphics, x[0], y[0]);
        ...
        renderPanel.addMouseMotionListener(new MouseMotionAdapter() {
            ...
            public void mouseDragged(MouseEvent e) {
                double y_i = 180.0 / renderPanel.getHeight();
                double x_i = 180.0 / renderPanel.getWidth();
                x[0] = (int) (e.getX() * x_i);
                y[0] = -(int) (e.getY() * y_i);
                renderPanel.repaint();
            }
